...
createWhatsAppMessage(data){let message=`Hi FiNix! I'm interested in getting a website for my coaching center.\n\n`;message+=`📚 Coaching Center: ${data.centerName}\n`;message+=`📱 Mobile: ${data.mobile}\n`;if(data.plan){const planNames={starter:"Starter Plan",standard:"Standard Plan",premium:"Premium Plan",custom:"Custom Requirements",};message+=`💼 Preferred Plan: ${planNames[data.plan]}\n`}
